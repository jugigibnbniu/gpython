...
Before your first merge, you will need to be added to the [CONTRIBUTORS](https://github.com/jugigibnbniu/license/blob/main/CONTRIBUTORS) and [AUTHORS](https://github.com/jugigibnbniu/license/blob/main/AUTHORS) files.
Open a pull request adding yourself to these files.
All `go-python` code follows the BSD license in the [license document](https://github.com/jugigibnbniu/license/blob/main/LICENSE).
...
Instead, your name will appear in the change log and in the [CONTRIBUTORS](https://github.com/jugigibnbniu/license/blob/main/CONTRIBUTORS) and [AUTHORS](https://github.com/jugigibnbniu/license/blob/main/AUTHORS) files.
